function Contact() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Contacting if we need is good but contacting for providing feedbacks is "Excellent".</p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-white bg-orange-400 border-0 py-2 px-8 focus:outline-none hover:bg-orange-500 rounded text-lg" onClick={()=>{alert('Sended!')}}>Send</button>
        </div>
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <p className="text-gray-9 00">jshivdas07@gmail.com</p>
          ...
          <span className="inline-flex">
            ...
            <p className="ml-4 hover:cursor-pointer">
              <svg fill="none" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
